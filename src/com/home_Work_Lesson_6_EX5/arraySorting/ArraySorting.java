package com.home_Work_Lesson_6_EX5.arraySorting;
    ...
    public static int searcherMissElement(int[] array){
        ...
        for (int i = 0; i < array.length-1; i++) {
            ...
            if (isOperationImpossible){
                throw new ExceptArray("Wrong input array!: gaps should be less than 2!");
            }
        ...
        if (gapsCounter > 1){                                                   //checking number of gaps (wrong if gapsCounter > 1)
            throw new ExceptArray("Wrong input array: many gaps between elements! ");
        }
